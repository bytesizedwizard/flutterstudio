...
class ScreenBackgroundOverlay extends Stack {
  ...
  ScreenBackgroundOverlay({this.child})
...
class ScreenBackgroundBasic extends Container {
  ...
  ScreenBackgroundBasic({this.child})
      : super(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [AppColors.primaryColor, AppColors.secondaryColor],
...
class _BackgroundEllipsePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    canvas.drawCircle(
        Offset(2 * size.width, 0), 1.75 * size.width, _customPaint);
  }
...
class _ForegroundEllipsePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    canvas.drawCircle(
        Offset(2 * size.width, 0), (2 * size.width), _customPaint);
  }
